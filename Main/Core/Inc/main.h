...
#define Bheight_Pin GPIO_PIN_0
#define Bheight_GPIO_Port GPIOC
#define Nheight_Pin GPIO_PIN_1
#define Nheight_GPIO_Port GPIOC
...
#define WSENSER_Pin GPIO_PIN_4
#define WSENSER_GPIO_Port GPIOA
